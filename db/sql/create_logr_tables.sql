...
CREATE TABLE `entity_type` (
  ...
  `default_owner_user_group_id` int(11) unsigned DEFAULT NULL,
  `sort_order` float(10,2) unsigned DEFAULT NULL,
  ...
  KEY `default_owner_user_group_entity_type_k3` (`default_owner_user_group_id`),
  ...
  CONSTRAINT `default_owner_user_group_entity_type_fk3` FOREIGN KEY (`default_owner_user_group_id`) REFERENCES `user_group` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
